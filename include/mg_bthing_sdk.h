...
struct mg_bthing_updating_state {
  mgos_bthing_updating_state_handler_t callback;
  void *userdata;
  struct mg_bthing_updating_state *next;
};
...
struct mg_bthing_sens {
  ...
  void *get_state_ud;
  struct mg_bthing_updating_state *updating_state;
